...
const (
	Node_Peek_FullMethodName = "/rabia_rpc.Node/Peek"
	Node_Read_FullMethodName = "/rabia_rpc.Node/Read"
)
...
func (c *nodeClient) Peek(ctx context.Context, in *PeekRequest, opts ...grpc.CallOption) (*PeekResponse, error) {
	...
	err := c.cc.Invoke(ctx, Node_Peek_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Node_Peek_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Node_Peek_FullMethodName,
	}
...
var Node_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "rabia_rpc/rabia.proto",
}
